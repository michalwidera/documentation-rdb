...
> **_NOTE:_** Functions and type propagation are covered by the integration tests `fncall_runtime_case`, `string_field_passthrough`, `issue121_isnull`, `issue128_numeric_to_string`, and `issue128_string_to_numeric`, and by the `ut_compiler`, `ut_expeval`, and `ut_facctxtsrc` unit tests.
